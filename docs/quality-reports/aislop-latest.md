...
- [!] `src/hooks/useAuth.ts:53` — complexity/function-too-long: Function 'AuthProvider' has 102 lines (max: 80)
- [!] `src/hooks/useAuth.ts:53` — complexity/deep-nesting: Function 'AuthProvider' has nesting depth 6 (max: 5)
