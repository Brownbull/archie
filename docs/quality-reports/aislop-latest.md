...
- [!!!] `tests/e2e/component-swapping.spec.ts:130` — knip/unresolved: Unresolved import: /src/stores/architectureStore.ts
- [!!!] `tests/e2e/component-swapping.spec.ts:131` — knip/unresolved: Unresolved import: /src/services/componentLibrary.ts
- [!!!] `tests/e2e/component-swapping.spec.ts:132` — knip/unresolved: Unresolved import: /src/lib/componentTypes.ts
...
- [!] `src/services/questLaunch.ts:8` — knip/exports: Unused export: FIRST_QUEST_ID
...
- [!] `src/components/auth/LoginPage.tsx:11` — complexity/function-too-long: Function 'LoginPage' has 153 lines (max: 80)
- [!] `src/components/layout/AppLayout.tsx:44` — complexity/function-too-long: Function 'AppLayout' has 91 lines (max: 80)
- [!] `src/components/layout/ModeToggle.tsx:27` — complexity/function-too-long: Function 'ModeToggle' has 108 lines (max: 80)
- [!] `src/hooks/useAuth.ts:55` — complexity/function-too-long: Function 'AuthProvider' has 113 lines (max: 80)
- [!] `src/hooks/useAuth.ts:55` — complexity/deep-nesting: Function 'AuthProvider' has nesting depth 6 (max: 5)
...
- [!] `package.json:0` — security/vulnerable-dependency: Vulnerable dependency (npm audit): esbuild (low)
...
- [!!!] `package.json:0` — security/vulnerable-dependency: Vulnerable dependency (npm audit): undici (high)
