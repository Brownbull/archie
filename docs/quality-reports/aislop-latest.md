...
- [!] `src/lib/challengeTracks.ts:30` — knip/exports: Unused export: CHALLENGE_TRACKS
...
- [!] `src/services/challengeLoader.ts:44` — knip/types: Unused type: ChallengeImportResult
