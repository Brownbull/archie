...
- [!] `src/engine/suggestionEngine.ts:41` — knip/types: Unused type: ArchitectureSuggestion
- [!] `src/engine/suggestionEngine.ts:64` — knip/types: Unused type: SuggestionResult
