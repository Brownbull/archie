...
- [!] `src/components/challenges/ChallengeResultsModal.tsx:198` — complexity/function-too-long: Function 'ChallengeResultsModal' has 302 lines (max: 80)
- [!] `src/components/simulation/PlaybackControls.tsx:6` — complexity/function-too-long: Function 'PlaybackControls' has 81 lines (max: 80)
