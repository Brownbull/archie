...
- [!] `src/engine/simulationEngine.ts:116` — complexity/function-too-long: Function 'simulateTick' has 167 lines (max: 80)
- [!] `src/engine/simulationEngine.ts:177` — complexity/function-too-long: Function 'process' has 98 lines (max: 80)
