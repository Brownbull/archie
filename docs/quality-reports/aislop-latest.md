...
- [!] `src/components/auth/LoginPage.tsx:12` — complexity/function-too-long: Function 'LoginPage' has 162 lines (max: 80)
- [!] `src/components/landing/LandingPage.tsx:59` — complexity/function-too-long: Function 'LandingPage' has 230 lines (max: 80)
