...
- [!] `src/components/challenges/BreakItPanel.tsx:66` — complexity/function-too-long: Function 'BreakItPanel' has 146 lines (max: 80)
- [!] `src/components/challenges/ChallengeResultsModal.tsx:200` — complexity/function-too-long: Function 'ChallengeResultsModal' has 364 lines (max: 80)
