...
- [!] `src/components/challenges/ChallengeResultsModal.tsx:199` — complexity/function-too-long: Function 'ChallengeResultsModal' has 348 lines (max: 80)
- [!] `src/components/simulation/SimulationStatsSidePanel.tsx:49` — complexity/function-too-long: Function 'SimulationStatsSidePanel' has 125 lines (max: 80)
