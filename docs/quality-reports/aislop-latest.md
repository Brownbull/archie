...
- [!] `src/components/challenges/ChallengeResultsModal.tsx:197` — complexity/function-too-long: Function 'ChallengeResultsModal' has 296 lines (max: 80)
