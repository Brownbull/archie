...
- [!] `src/components/challenges/ChallengeResultsModal.tsx:38` — complexity/function-too-long: Function 'ChallengeResultsModal' has 110 lines (max: 80)
