...
- [!] `src/components/landing/LandingPage.tsx:78` — complexity/function-too-long: Function 'LandingPage' has 197 lines (max: 80)
...
- [!] `src/components/landing/LandingPage.tsx:111` — jsx-a11y/alt-text: Missing `alt` attribute.
