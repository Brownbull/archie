...
- [!] `src/components/layout/LeaderboardDialog.tsx:26` — complexity/function-too-long: Function 'LeaderboardDialog' has 87 lines (max: 80)
- [!] `src/components/layout/ModeToggle.tsx:26` — complexity/function-too-long: Function 'ModeToggle' has 102 lines (max: 80)
