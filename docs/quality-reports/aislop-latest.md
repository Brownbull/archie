...
- [!] `src/components/challenges/ChallengeResultsModal.tsx:164` — complexity/function-too-long: Function 'ChallengeResultsModal' has 137 lines (max: 80)
- [!] `src/components/layout/ModeToggle.tsx:26` — complexity/function-too-long: Function 'ModeToggle' has 81 lines (max: 80)
