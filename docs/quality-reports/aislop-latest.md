...
- [!] `src/components/challenges/ChallengeHud.tsx:15` — complexity/function-too-long: Function 'ChallengeHud' has 118 lines (max: 80)
...
- [!] `src/components/layout/LeaderboardDialog.tsx:32` — complexity/function-too-long: Function 'LeaderboardDialog' has 137 lines (max: 80)
- [!] `src/components/layout/LeaderboardDialog.tsx:32` — complexity/deep-nesting: Function 'LeaderboardDialog' has nesting depth 6 (max: 5)
