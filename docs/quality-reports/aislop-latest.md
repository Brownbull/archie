...
- [!] `src/components/landing/LandingPageGif.tsx:28` — complexity/function-too-long: Function 'LandingPageGif' has 145 lines (max: 80)
...
- [!] `src/components/landing/LandingPageGif.tsx:50` — jsx-a11y/alt-text: Missing `alt` attribute.
