...
export function ExportButton() {
  ...
  const handleExport = useCallback(() => {
    const { nodes, edges, weightProfile, constraints, dataContextItems, activeScenarioId, activeFailureScenarioId } = getArchitectureSkeleton()
    ...
    try {
      const yamlString = exportArchitecture(nodes, edges, weightProfile, constraints, dataContextItems, activeScenarioId, activeFailureScenarioId)
