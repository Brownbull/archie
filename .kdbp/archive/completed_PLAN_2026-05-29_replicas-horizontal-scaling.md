...
- **Date:** 2026-05-29
- **Reason:** Goal achieved — all 4 phases shipped + deployed (P15–P18). Replicas & horizontal scaling: per-node replica count, scaling rules, cost/capacity scaling, canvas stepper + badges, topology rule, schema v4 round-trip. Deferred TD: D2/D6 (oversized test files), D3 (architectureStore.ts >800), D4 (ComponentDetail eslint debt), D5 (stale Epic-12 e2e specs).
